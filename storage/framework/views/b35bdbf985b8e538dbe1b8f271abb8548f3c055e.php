            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    ...
                    <span class="text-center text-white">
                        <?php echo e(auth()->user()->getRoleNames()[0] ?? "Pengguna"); ?>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('stok.trip.cek')); ?>" class="nav-link link-stock-history">
...
<?php /**PATH C:\Users\BAC 2\Desktop\dev\inventory-stock-master\resources\views/layouts/app.blade.php ENDPATH**/ ?>